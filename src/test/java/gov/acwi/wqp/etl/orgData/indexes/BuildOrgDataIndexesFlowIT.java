package gov.acwi.wqp.etl.orgData.indexes;
...
public class BuildOrgDataIndexesFlowIT extends NwisBaseFlowIT {

	public static final String EXPECTED_DATABASE_QUERY = "select tablename, indexname, indexdef from pg_indexes where tablename='org_data_swap_nwis'";
	...
	@Before
	public void setUp() {
		testJob = jobBuilderFactory.get("BuildOrgDataIndexesFlowTest")
	...
	public void buildOrgDataOrganizationIndexStepTest() {
		try {
			JobExecution jobExecution = jobLauncherTestUtils
					.launchStep("buildOrgDataOrganizationIndexStep", testJobParameters);
