...
public class NwisActivityRowMapper implements RowMapper<NwisActivity> {
	...
	public static final String WQX_ACT_MED_SUB_COLUMN_NAME = "wqx_act_sub";
	...
	public static final String V00098_COLUMN_NAME = "v000098";
	...
	public static final String HYD_COND_NM_COLUMN_NAME = "";
	public static final String HYD_EVENT_NM_COLUMN_NAME = "";
	...
	public NwisActivity mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		nwisActivity.setSampleStartDt(LocalDate.parse(rs.getString(SAMPLE_START_DT_COLUMN_NAME)));
		...
		nwisActivity.setSampleStartSg(rs.getString(SAMPLE_START_SG_COLUMN_NAME).charAt(0));
		nwisActivity.setSampleStartTimeDatumCd(rs.getString(SAMPLE_START_TIME_DATUM_CD_COLUMN_NAME));
		nwisActivity.setSampleEndSg(rs.getString(SAMPLE_END_SG_COLUMN_NAME).charAt(0));
