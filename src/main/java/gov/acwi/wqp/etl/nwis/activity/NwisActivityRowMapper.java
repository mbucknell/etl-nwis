...
public class NwisActivityRowMapper implements RowMapper<NwisActivity> {
	...
	private static final String STATION_ID_COLUMN_NAME = "station_id";
	private static final String SITE_ID_COLUMN_NAME = "site_id";
	private static final String SAMPLE_START_DT_COLUMN_NAME = "sample_start_dt";
	private static final String NWIS_HOST_COLUMN_NAME = "nwis_host";
	private static final String QW_DB_NO_COLUMN_NAME = "qw_db_no";
	private static final String RECORD_NO_COLUMN_NAME = "record_no";
	private static final String WQX_ACT_MED_NM_COLUMN_NAME = "wqx_act_med_nm";
	private static final String ORGANIZATION_COLUMN_NAME = "organization";
	private static final String SITE_TYPE_COLUMN_NAME = "site_type";
	private static final String HUC_COLUMN_NAME = "huc";
	private static final String GOVERNMENTAL_UNIT_CODE_COLUMN_NAME = "governmental_unit_code";
	...
	private static final String SAMP_TYPE_CD_COLUMN_NAME = "samp_type_cd";
	private static final String WQX_ACT_MED_SUB_COLUMN_NAME = "wqx_act_med_sub";
	private static final String SAMPLE_START_SG_COLUMN_NAME = "sample_start_sg";
	private static final String SAMPLE_START_TIME_DATUM_CD_COLUMN_NAME = "sample_start_time_datum_cd";
	private static final String SAMPLE_END_SG_COLUMN_NAME = "sample_end_sg";
	private static final String SAMPLE_END_DT_COLUMN_NAME = "sample_end_dt";
	private static final String V00003_COLUMN_NAME = "v00003";
	private static final String V00098_COLUMN_NAME = "v00098";
	private static final String V50280_COLUMN_NAME = "v50280";
	private static final String V71999_COLUMN_NAME = "v71999";
	private static final String V72015_COLUMN_NAME = "v72015";
	private static final String V72016_COLUMN_NAME = "v72016";
	private static final String V78890_COLUMN_NAME = "v78890";
	private static final String V78891_COLUMN_NAME = "v78891";
	private static final String V82047_COLUMN_NAME = "v82047";
	private static final String V82048_COLUMN_NAME = "v82048";
	private static final String V82398_COLUMN_NAME = "v82398";
	private static final String V82398_FXD_TX_COLUMN_NAME = "v82398_fxd_tx";
	private static final String V84164_FXD_TX_COLUMN_NAME = "v84164_fxd_tx";
	private static final String NAWQA_SITE_NO_COLUMN_NAME = "nawqa_site_no";
	private static final String PROTO_ORG_NM_COLUMN_NAME = "proto_org_nm";
	private static final String COLL_ENT_CD_COLUMN_NAME = "coll_ent_cd";
	private static final String SAMPLE_LAB_CM_TX_COLUMN_NAME = "sample_lab_cm_tx";
